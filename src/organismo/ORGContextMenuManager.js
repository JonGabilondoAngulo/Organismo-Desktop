    ...
    _menuItemsForScreen() {
        ...
        if (controller.type === 'WDA') {
            ...
            items[ORGActions.SET_ORIENTATION] = {
                ...
                items: {
                    [ORGDeviceORIENTATION.PORTRAIT]: {name: "Portrait"},
                    [ORGDeviceORIENTATION.LANDSCAPE_LEFT]: {name: "Landscape Left"},
                    [ORGDeviceORIENTATION.LANDSCAPE_RIGHT]: {name: "Landscape Right"},
                    [ORGDeviceORIENTATION.PORTRAIT_UPSIDE_DOWN]: {name: "Upside Down"}
                }
            }
        }
