    ...
    getDeviceOrientation() {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let orientation = ORGDeviceORIENTATION.PORTRAIT;
                switch (result) {
                    case "PORTRAIT": break;
                    case "LANDSCAPE": orientation = ORGDeviceORIENTATION.LANDSCAPE_LEFT; break;
                    case "UIA_DEVICE_ORIENTATION_LANDSCAPERIGHT": orientation = ORGDeviceORIENTATION.LANDSCAPE_RIGHT; break;
                    case "UIA_DEVICE_ORIENTATION_PORTRAIT_UPSIDEDOWN": orientation = ORGDeviceORIENTATION.PORTRAIT_UPSIDE_DOWN; break;
                }
                resolve(orientation);
            } catch (err) {
                reject(err);
    ...
    setOrientation(orientation) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                switch (orientation) {
                    case ORGDeviceORIENTATION.PORTRAIT_UPSIDE_DOWN: {wdaOrientation = "UIA_DEVICE_ORIENTATION_PORTRAIT_UPSIDEDOWN"} break;
                    case ORGDeviceORIENTATION.LANDSCAPE_LEFT: {wdaOrientation = "LANDSCAPE"} break;
                    case ORGDeviceORIENTATION.LANDSCAPE_RIGHT: {wdaOrientation = "UIA_DEVICE_ORIENTATION_LANDSCAPERIGHT"} break;
                }
