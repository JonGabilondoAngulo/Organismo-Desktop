...
const ORGWebSocket = require('./ORGWebSocket')
const ORGWebSocketDeviceController = require('./ORGWebSocketDeviceController')
const ORGMessageBuilder = require('./ORGMessageBuilder')
...
class ORGDeviceController extends ORGWebSocketDeviceController {
    ...
    convertInterfaceOrientation(iOSOrientation) {
        ...
        switch(iOSOrientation) {
            case "UIInterfaceOrientationPortrait": orientation = ORGDeviceORIENTATION.PORTRAIT; break;
            case "UIInterfaceOrientationPortraitUpsideDown": orientation = ORGDeviceORIENTATION.PORTRAIT_UPSIDE_DOWN; break;
            case "UIInterfaceOrientationLandscapeRight": orientation = ORGDeviceORIENTATION.LANDSCAPE_RIGHT; break;
            case "UIInterfaceOrientationLandscapeLeft": orientation = ORGDeviceORIENTATION.LANDSCAPE_LEFT; break;
            case "UIInterfaceOrientationFaceUp": orientation = ORGDeviceORIENTATION.FACE_UP; break;
            case "UIInterfaceOrientationFaceDown": orientation = ORGDeviceORIENTATION.FACE_DOWN; break;
        }
        return orientation;
    }
    ...
    _convertOrientation(iOSOrientation) {
        let orientation
        switch(iOSOrientation) {
            case "UIDeviceOrientationPortrait": orientation = ORGDeviceORIENTATION.PORTRAIT; break;
            case "UIDeviceOrientationPortraitUpsideDown": orientation = ORGDeviceORIENTATION.PORTRAIT_UPSIDE_DOWN; break;
            case "UIDeviceOrientationLandscapeRight": orientation = ORGDeviceORIENTATION.LANDSCAPE_RIGHT; break;
            case "UIDeviceOrientationLandscapeLeft": orientation = ORGDeviceORIENTATION.LANDSCAPE_LEFT; break;
            case "UIDeviceOrientationFaceUp": orientation = ORGDeviceORIENTATION.FACE_UP; break;
            case "UIDeviceOrientationFaceDown": orientation = ORGDeviceORIENTATION.FACE_DOWN; break;
        }
        return orientation;
    }
}