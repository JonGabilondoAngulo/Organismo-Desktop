...
const ORG3DWDAUIElement = require('./ORG3DWDAUIElement')
const ORG3DORGUIElement = require('./ORG3DORGUIElement')
const ORGUIJSONWDATreeAdaptor = require('./ORGUIJSONWDATreeAdaptor')
const ORGUIJSONOrganismoTreeAdaptor = require('./ORGUIJSONOrganismoTreeAdaptor')

const ORGJSONTreeType = {
        WDA: 0,
        ORGANISMO: 1
}
...
class ORGUIJSONTreeManager {
    ...
    update(jsonTree, treeType) {
        ...
        switch (treeType) {
            case ORGJSONTreeType.WDA : {
                this._treeAdaptor =  ORGUIJSONWDATreeAdaptor;
            } break;
            case ORGJSONTreeType.ORGANISMO : {
...
module.exports = { ORGUIJSONTreeManager, ORGJSONTreeType }
